export default {
  ...
  terminal: {
    ...
    copyFailed: '复制失败',
    copyAgentSessionId: '复制 {agent} Session ID',
    agentSessionIdCopied: '{agent} Session ID 已复制到剪贴板',
    copyCkbSessionId: '复制 CKB Session ID',
    ckbSessionIdCopied: 'CKB Session ID 已复制到剪贴板',
  ...
  webSession: {
    ...
    moreModels: '更多',
    allModels: '全部模型',
    recentlyUsedModels: '最近使用',
    removeRecentModel: '移除',
    recommendedModels: '推荐',
    modelDetailContext: '上下文 {count}',
    modelDetailOutput: '输出 {count}',
    modelDetailEfforts: '思维档位：{list}',
    fusionLead: '主导模型',
    fusionEffort: '思维强度',
    fusionSidekick: '协作模型',
    fusionSidekickEffort: '协作强度',
    fusionFastMode: '快速模式',
    fusionCost: '费用',
    ...
    customModelManage: '管理自定义模型',
    customModelManageTitle: '管理自定义模型',
    customModelManageEmpty: '暂无保存的自定义模型',
    customModelDelete: '删除',
    ...
    composerHintDevinMissing: '未检测到 Devin CLI，请先安装并完成登录后再发送会话消息。',
    devinNotInstalledAgentLabel: 'Devin（未安装）',
