export default {
  ...
  terminal: {
    ...
    agentSessionIdCopied: '{agent} Session ID copied to clipboard',
    copyCkbSessionId: 'Copy CKB Session ID',
    ckbSessionIdCopied: 'CKB Session ID copied to clipboard',
  ...
  webSession: {
    ...
    recentlyUsedModels: 'Recently Used',
    removeRecentModel: 'Remove',
    recommendedModels: 'Recommended',
    modelDetailContext: 'Context {count}',
    modelDetailOutput: 'Output {count}',
    modelDetailEfforts: 'Thinking: {list}',
    fusionLead: 'Lead',
    fusionEffort: 'Effort',
    fusionSidekick: 'Sidekick',
    fusionSidekickEffort: 'Sidekick effort',
    fusionFastMode: 'Fast Mode',
    fusionCost: 'Cost',
    ...
    customModelManage: 'Manage custom models',
    customModelManageTitle: 'Manage Custom Models',
    customModelManageEmpty: 'No saved custom models',
    customModelDelete: 'Delete',
    ...
    composerHintDevinMissing:
      'Devin CLI was not detected. Install and authenticate Devin before sending web session messages.',
    devinNotInstalledAgentLabel: 'Devin (not installed)',
